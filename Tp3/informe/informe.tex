...
% you desire.
\markboth{Teor\'ia de las Comunicaciones}{, Departamento de Computaci\'on, FCEyN - UBA, Noviembre 2014}
...
\begin{IEEEkeywords}
    Teor\'ia de las Comunicaciones, UBA, FCEyN, TCP, PTC, End-To-End,
    Conexion-Oriented, TP3
\end{IEEEkeywords}}
...
\section{Las Variables y M\'etricas}
\input{variables_metricas}
