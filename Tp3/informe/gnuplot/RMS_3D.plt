...
#set ytics 2 offset 0,-1
set view 60,30,1,1
splot "prob0_delay0_final.csv" using 1:2:3 with lines title "0ms",\
    "prob0_delay50_final.csv" using 1:2:3 with lines title "50ms",\
    "prob0_delay100_final.csv" using 1:2:3 with lines title "100ms",\
    "prob0_delay250_final.csv" using 1:2:3 with lines title "250ms",\
    "prob0_delay500_final.csv" using 1:2:3 with lines title "500ms"
...
#unset ytics
set view 90,0,1,1
#splot "prob0_delay0_final.csv" using 1:2:3 with lines title "RMS"
splot "prob0_delay0_final.csv" using 1:2:3 with lines title "0ms",\
    "prob0_delay50_final.csv" using 1:2:3 with lines title "50ms",\
    "prob0_delay100_final.csv" using 1:2:3 with lines title "100ms",\
    "prob0_delay250_final.csv" using 1:2:3 with lines title "250ms",\
