...
\title{Trabajo Pr\'actico 2: Rutas en Internet}
%
%
...
% you desire.
\markboth{Teor\'ia de las Comunicaciones}{, Departamento de Computaci\'on, FCEyN - UBA, Octubre 2014}
...
\begin{IEEEkeywords}
    Teor\'ia de las Comunicaciones, UBA, FCEyN, Ruteo, Routing, TP2
\end{IEEEkeywords}}
...
%\section*{Sobre el \textit{traceroute} implementado}\label{sec:traceroute}
%    \input{traceroute}
