...
int main(int argc, char** args) {
    ...
    if(argc != 3) {
        cout << "Uso: " << endl;
        cout << args[0] << " [interface] [destino]" << endl;
        result = 1;
    ...
    /* Set the interface */
        ...
        SendRecv(tcp_packets.begin(),tcp_packets.end(),ret_packets.begin(),iface,1.0,3,48);
